...
The [Divi Responsive Image Size](https://wptools.app/wordpress-plugin/divi-responsive-image-sizes-plugin/) plugin has two modules.
...
* [Gravity Forms Divi Module](https://wptools.app/wordpress-plugin/gravity-forms-divi-module/?utm_source=wp&utm_medium=plugin-page&utm_campaign=responsive-images&utm_content=ups)
* [FAQ Plugin For Divi](https://wptools.app/wordpress-plugin/faq-manager-with-structured-data/?utm_source=wp&utm_medium=plugin-page&utm_campaign=responsive-images&utm_content=ups)
* [Image Carousel For Divi](https://wptools.app/wordpress-plugin/image-carousel-for-divi/?utm_source=wp&utm_medium=plugin-page&utm_campaign=responsive-images&utm_content=ups)
* [Product Carousel For Divi](https://wptools.app/wordpress-plugin/product-carousel-for-divi/?utm_source=wp&utm_medium=plugin-page&utm_campaign=responsive-images&utm_content=ups)
* [Contact Form 7 Grid & Styler For Divi](https://wptools.app/wordpress-plugin/grid-styler-for-contact-form-7-and-divi/?utm_source=wp&utm_medium=plugin-page&utm_campaign=responsive-images&utm_content=ups)
* [Blog Carousel For Divi](https://wptools.app/wordpress-plugin/divi-blog-carousel/?utm_source=wp&utm_medium=plugin-page&utm_campaign=responsive-images&utm_content=ups)
...
= 1.2.0 =
* Fixed bug where **scaled** image url is being used.
